...
public class AccountService implements IAccountService {
	...
	public void saveAccountAndSendEmial(AccountDTO account) {
		...
		StringBuffer content=new StringBuffer()
				.append("<html><body><h3>你好，请点击以下网址激活账号，30分钟内有效</h3>")
				.append("\n<a style=\"text-decoration:none\"")
				.append("href=\"").append(getAddress()).append("account/")
				.append("activate?activationCode=").append(uuidCode)
				.append("&email=").append(user.getEmail()).append("\"")
				.append("<h3>账号激活_快来点我啊</h3></a></body></html>");
	...
	public String getAddress() {
		...
		StringBuffer sb=new StringBuffer().append("http://")
	...
	public void sendEmailToChangePassword(AccountDTO account) {
		...
		StringBuffer content=new StringBuffer()
				.append("<html><body><h3>你好，请点击以下网址修改密码，30分钟内有效</h3>")
				.append("\n<a style=\"text-decoration:none\"")
				.append("href=\"").append(getAddress()).append("account/")
				.append("writePassword?activationCode=").append(uuidCode)
				.append("&email=").append(user.getEmail()).append("\"")
				.append("<h3>密码修改_快来点我啊</h3></a></body></html>");
		SendEmailUtil.sendHtmlMail(user.getEmail(), subject, content.toString());
	}
	/**
	 * 修改密码
