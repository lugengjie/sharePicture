...
public class AccountController
{
	...
	/*
	 * 注册 邮箱是否存在 ？-》是，账号是否激活？-》是，账号已被注册 -》否，请尽快激活 -》否，请尽快激活
	 * 
	 * @param accountDTO
	 * 
	 * @return
	...
	/**
	 * 登录 填写账号密码-》邮箱是否存在?-》是，账号是否激活？-》是，密码是否正确?-》是，登录成功 -》否，账号不存在 -》否，请尽快激活 -》否，密码错误
	 * 
	 * @param accountDTO
	 * @return
	 */
	...
	/**
	 * 激活账号 激活码和账号是否正确？-》是，激活码是否超时？-》是，激活码超时 -》否 -》否，激活成功
	 * 
	 * @param accountDTO
	 * @return
	 */
